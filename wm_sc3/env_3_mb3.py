...
import json
import torch
RAMDISK_BASE = "/root/clrm/wm_sc3/env_w_dir"  # Where we want our env's working directory
SOURCE_DIR = "/root/clrm/wm_sc3"  # Where TRUE_DECK0R.DATA and TRUE_DECK0.DATA are located
...
class ReservoirEnv(gym.Env):
    ...
    def modify_deck(self, action, step):
        ...
        gconinje_string = f'''
            ...
            'I2' 'GAS' 'OPEN' 'RATE' {gas_inj2}E3 1* 8500 /
