...
import json
import torch
RAMDISK_BASE = "/dev/shm/drlcs4"  # Where we want our env's working directory
SOURCE_DIR = "/home/ubuntu/clrm/drlcs4"  # Where TRUE_DECK0R.DATA and TRUE_DECK0.DATA are located
