...
import json
import torch 
RAMDISK_BASE = "/root/clrm/wm_sc0/env_w_dir"  # Where we want our env's working directory
SOURCE_DIR = "/root/clrm/wm_sc0"  # Where TRUE_DECK0R.DATA and TRUE_DECK0.DATA are located
...
class ReservoirEnv(gym.Env):
    def __init__(self,env_id):
        ...
        if int(self.env_id) in [151,161,171,181,191,201,211,221]:  # Testing case, use TRUE_DECK
